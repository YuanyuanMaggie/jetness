  ...
  render() {
    return (
      <div className="set-date">
        ...
        <div className="day">
          <div>Day</div><InputPlaceHolder placeholder='M' /><div className="icon-caret-down"></div>
        </div>
        <div className="month">
          <div>Month</div><InputPlaceHolder placeholder='M' /><div className="icon-caret-down"></div>
        </div>
      </div>
    );
  }
