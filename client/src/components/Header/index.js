...
const HeaderLeft = () => (
    <div className="header-left font-bold">
        <a href="/" className="relative logo">
            <i className="icon-jet hide-small hide-medium"></i>
            <i className="icon-j hide-large"></i>
        </a>
        <div>
        <a href="/" className="nav-cat hide-small hide-medium">
            Categories
            <span>
                <i className="icon-caret-down ml1 smaller"></i>
            </span>
        </a>
        </div>
    </div>
...
const HeaderMid = () => (
    <div className="header-mid font-bold">
        <div className="search">
            ...
            <div className="icon icon-search h4 i-search"></div>
        </div>
        <div className="search-below hide-small hide-medium">
            <div>
                ...
                <a href="https://jet.com/why-shop-jet"><span className="pr3 small">24/7 Help<i className="icon-caret-down ml1 smaller"></i></span></a>
            </div>
            <div>
                <a href="https://jet.com/account"><span className="pr3 small">Account <i className="icon-caret-down ml1 smaller"></i></span></a>
